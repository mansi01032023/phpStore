...
?>
<h1 class="text-center p-0 m-0">My Wishlist</h1><br><br>
<?php
if (isset($_COOKIE['userid'])) {
    $userid = $_COOKIE['userid'];
    $stmt = "SELECT * FROM `wish` where `user_id` = '$userid'";
    ...
    if ($result->num_rows > 0) {
        ...
        <a href='#' class='text-danger m-2' data-mdb-toggle='tooltip' id='delete" . $row['product_id'] . "' onclick='deleteWishlist(this.id)'><i
